...
# PS_v1_path = "/baai-cwm-1/baai_cwm_ml/cwm/hong.li/code/3dgen/data/zeroverse/3diclight_matsynth/3diclight_meta_6k_single_v2"  
# PS_v1_path = "/baai-cwm-1/baai_cwm_ml/cwm/hong.li/code/3dgen/data/zeroverse/dora_bench_meshes"  
...
def main():  
    blend_file_dirs = [os.path.join(PS_v1_path, f"level_{int(i / 1500 + 1)}", f"{i:06d}") for i in range(6000)]  
    blend_files = []  
    ...
    if results:  
        ...
        output_csv = os.path.join(PS_v1_path, "metadata_PS_v2_6w.csv")  
