...
# PS_v1_path = "/baai-cwm-1/baai_cwm_ml/cwm/hong.li/code/3dgen/data/zeroverse/output_all/PS_v2_6w"  
PS_v1_path = "/baai-cwm-1/baai_cwm_ml/cwm/hong.li/code/3dgen/data/zeroverse/output_all/diligentplane_v1"  
...
def main():  
    # blend_file_dirs = [os.path.join(PS_v1_path, f"level_{int(i / 15000 + 1)}", f"{i:06d}") for i in range(60000)]  
    blend_file_dirs = [os.path.join(PS_v1_path, f"level_{int(i / 1000 + 1)-1}", f"{i:06d}") for i in range(2000)]  
    blend_files = []  
    ...
    if results:  
        ...
        output_csv = os.path.join(PS_v1_path, "metadata_PS_plane_v1_2k.csv")  
