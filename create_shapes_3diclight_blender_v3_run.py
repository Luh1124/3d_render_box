...
def render_task(index):  
    ...
    """  
    output_dir = "/baai-cwm-1/baai_cwm_ml/cwm/hong.li/code/3dgen/data/zeroverse/output_all/3diclight_meta_6k_single_v2"  
    os.makedirs(output_dir, exist_ok=True)
    level = index // 1500 + 1  
    scene_uuid = uuid.uuid4().hex  
    script_path = os.path.join(os.path.dirname(__file__), 'create_shapes_3diclight_blender_v3.py')  
