...
# Default parameters  
DEFAULT_OUTPUT_DIR="render_all/dorabenchmark_render_relight_0718"  
DEFAULT_SUBSET="3diclight"  
DEFAULT_OUTBASE="render_relight_25views"  # Default output base name
RANK=0
WORLD_SIZE=8
MAX_WORKERS=12
...
echo "python dataset_toolkits/run_render_3diclight_dora_relight_slat.py $SUBSET --output_dir $OUTPUT_DIR --out_basename $OUTBASE --rank $RANK --world_size $WORLD_SIZE --max_workers $MAX_WORKERS"
...
python dataset_toolkits/run_render_3diclight_dora_relight_slat.py $SUBSET --output_dir $OUTPUT_DIR --out_basename $OUTBASE --rank $RANK --world_size $WORLD_SIZE --max_workers $MAX_WORKERS
