...
DEFAULT_OUTBASE="even_render_6k"  # Default output base name
RANK=0
WORLD_SIZE=6
MAX_WORKERS=12
...
echo "python dataset_toolkits/run_render_3diclight_even.py $SUBSET --output_dir $OUTPUT_DIR --out_basename $OUTBASE --rank $RANK --world_size $WORLD_SIZE --max_workers $MAX_WORKERS"
...
python dataset_toolkits/run_render_3diclight_even.py $SUBSET --output_dir $OUTPUT_DIR --out_basename $OUTBASE --rank $RANK --world_size $WORLD_SIZE --max_workers $MAX_WORKERS
