...
# Default parameters  
DEFAULT_OUTPUT_DIR="render_all/3diclight_matsynth_6k_render_slat_0712"  
DEFAULT_SUBSET="3diclight"  
DEFAULT_OUTBASE="render_relight_150views"  # Default output base name
RANK=0
WORLD_SIZE=6
MAX_WORKERS=12
...
echo "python dataset_toolkits/run_render_3diclight_6k_relight_slat.py $SUBSET --output_dir $OUTPUT_DIR --out_basename $OUTBASE --rank $RANK --world_size $WORLD_SIZE --max_workers $MAX_WORKERS"
...
python dataset_toolkits/run_render_3diclight_6k_relight_slat.py $SUBSET --output_dir $OUTPUT_DIR --out_basename $OUTBASE --rank $RANK --world_size $WORLD_SIZE --max_workers $MAX_WORKERS
