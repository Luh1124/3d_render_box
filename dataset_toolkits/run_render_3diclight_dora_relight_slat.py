...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_dir', type=str, default="render_all/dorabenchmark_render_relight_0718",
    ...
    parser.add_argument('--out_basename', type=str, default="render_relight_25_views", help='The basename of the output directory')
