...
def _render(file_path, sha256, level, output_dir, num_views=12, num_lights=16, low_normal=True, out_basename="render"):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--out_basename', type=str, default="PS_v3_render", help='The basename of the output directory')
    ...
    # process objects
    func = partial(_render, output_dir=opt.output_dir, num_views=opt.num_views, num_lights=opt.num_lights, low_normal=False, out_basename=opt.out_basename)
