...
if __name__ == '__main__':
    ...
    # get file list
    if not os.path.exists("/baai-cwm-vepfs/cwm/hong.li/code/3dgen/benchmark/3DTopia-XL/metadatas/level1_data.csv"):
        raise ValueError('level1_data.csv not found')
    metadata = pd.read_csv("/baai-cwm-vepfs/cwm/hong.li/code/3dgen/benchmark/3DTopia-XL/metadatas/level1_data.csv")
