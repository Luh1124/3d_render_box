...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_dir', type=str, default="/baai-cwm-vepfs/cwm/hong.li/code/3dgen/benchmark/MeshGen/dorabenchmark/texturing_0727",
    ...
    # get file list
    if not os.path.exists("/baai-cwm-vepfs/cwm/hong.li/code/3dgen/benchmark/MeshGen/metadatas/level2_data.csv"):
        raise ValueError('level2_data.csv not found')
    metadata = pd.read_csv("/baai-cwm-vepfs/cwm/hong.li/code/3dgen/benchmark/MeshGen/metadatas/level2_data.csv")
