...
def _voxelize(file, sha256, level, output_dir, out_basename):
    mesh = o3d.io.read_triangle_mesh(os.path.join(output_dir, 'render_relight_150views', f'level_{level}', sha256, 'mesh.ply'))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_dir', type=str, default="/baai-cwm-vepfs/cwm/hong.li/code/3dgen/data/zeroverse/render_all/3diclight_matsynth_6k_render_slat_0712",
